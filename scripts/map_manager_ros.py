...
class Server:
    def __init__(self, map_manager, save_dir=""):
        ...
        self.dat = {"p": self.map_manager.p.copy(),
               "cloud": {"points": self.map_manager.ref_points,
                         "normals": self.map_manager.ref_normal},
    ...
    def send_region_idx(self, req):
        region_idx=[]
        for i, idx in self.map_manager.region_idx.items():
