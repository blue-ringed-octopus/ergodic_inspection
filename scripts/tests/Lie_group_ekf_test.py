...
def get_pixel_jacobian(mu, xl, kx, K):
    c=cos(mu[2])
    s=sin(mu[2])
...
for r in result:
    ...
    features[r.tag_id]= {"xp": xp, "yp": yp, "z":z, "R": Rot, "t": t}
...
for feature_id in features:    
    ...
    Jloc=get_pixel_jacobian(mu, xl, kx, K) #jacobian of robot pose (x,y, theta) and tag location (x,y,z)
